...
class RegisterActivity : BaseActivity<RegisterViewState>(), RegisterContract.View {
    ...
    private val viewModel: RegisterContract.Presenter by inject<RegisterPresenter>()
    ...
    override fun getPresenter(): StatePresenter<RegisterViewState, BaseView> = viewModel as StatePresenter<RegisterViewState, BaseView>
}
